...
def aboutScreen(lblUnderline):
	...
	leftJustifyText(7, "\tNAB quotes taken from http://usccb.org/bible/books-of-the-bible")

	screen.addstr(9, 2, "Display:", lblUnderline)
	leftJustifyText(11, "Dynamic window resize works on Powershell, WSL, and terminals on non-tiling Linux window managers." )
	leftJustifyText(12, "Current display: (" + str(maxX) + "x, " + str(maxY) + "y)." + " | Minimum display: (140x, 40y)" )

	screen.addstr(14, 2, "Instructions:", lblUnderline)
	leftJustifyText(16, "The first mystery defaults to the mystery of the day." )
	leftJustifyText(17, "Reset to a desired mystery. Number Keys (0-4) correspond with: (Daily, Joy, Luminous, Sorrow, & Glory)." )
	leftJustifyText(18, "Press the right/left arrow keys to navigate forward/reverse." )
	leftJustifyText(19, "\tthe h/l vim keys to navigate forward/reverse." )
	leftJustifyText(20, "\tthe a/d game arrow keys to navigate forward/reverse." )
	leftJustifyText(21, "Number keys 0-4 will jump to a mystery, 0 is the mystery of the day." )
	leftJustifyText(23, "Press Q to quit app." )
